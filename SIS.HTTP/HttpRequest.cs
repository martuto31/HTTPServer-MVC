...
namespace SIS.HTTP
{
    public class HttpRequest
    {
        ...
        {
            //parsvame headurite i infoto ot tqh v string
            this.Headers = new List<Header>();
            var lines = httpRequestAsString.Split(new string[] { HttpConst.NewLine }, StringSplitOptions.None);
